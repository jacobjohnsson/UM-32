  ...
  I Have decided to add the following instruction.

           #14. Subtraction.

                  The register A receives the value in register B minus 
                  the value in register C, modulo 2^32.

           #15. Modulo.

                  The register A receives the value in register B modulo 
